...
//                         <div
//                           className={`flex gap-5 p-5 ${videoActive === topic._id ? "bg-yellow-200 text-richblack-900":""} `
//                         }
//                         key={index}
//                         onClick={()=>
  ...
  return (
    <>
     <div className={`${showSidebar?"":"hidden"} w-6 h-72 md:hidden relative `}>
      <FaAngleDoubleRight onClick={()=>{setShowSidebar(!showSidebar);}} className={`  z-10 cursor-pointer text-2xl text-richblack-900 m-2 bg-richblack-100 rounded-full p-1 top-3 absolute -left-1 `} />
      </div>
