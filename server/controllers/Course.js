...
exports.createCourse = async (req, res) => {
	...
	// 	console.log("hahhhhhhhhhhhhhhhhhhhh",req.body)
	...
	try {
		...
		const tagz = req.body._tag;
		const instruc = req.body._instruction;
		console.log("tagz",tagz);
		// Get thumbnail image from request files
		const thumbnail = req.files.thumbnailImage
		// console.log("thumb",_tag);
		
		// Convert the tag and instructions from stringified Array to Array
		const tag = JSON.parse(tagz);
		console.log("tag",tag)
		const instructions = JSON.parse(instruc)
